...
# Directory that contains THIS file  →  src/utils/
_UTILS_DIR = os.path.dirname(os.path.abspath(__file__))
# One level up                       →  src/
_SRC_DIR = os.path.dirname(_UTILS_DIR)
# Canonical assets dir               →  src/assets/
_ASSETS_DIR = os.path.join(_SRC_DIR, "assets")
...
def find_jar(name: str) -> str:
    ...
    """
    candidates = [
        os.path.join(_ASSETS_DIR, name),                        # src/assets/
        os.path.join(_SRC_DIR, "..", "assets", name),           # assets/ (module root)
