...
Always creates: .env, config.ini, ragpdf_data/ with sample data.
"""
...
def _create_ragpdf_data(base: str = "./ragpdf_data", force: bool = False):
    # Folder skeleton
    for d in [
        f"{base}/input/fields",
        f"{base}/vectors",
...
def main():
    ...
    parser.add_argument("--path",  default="./ragpdf_data", help="Data folder path (default: ./ragpdf_data)")
...
""")
    ...
    # ── Always: .env, config.ini, ragpdf_data/ ────────────────
